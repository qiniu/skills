...
set -euo pipefail
# 初始化逻辑...
echo "Initializing ${var.app_name}..."
USERDATA
  )
...
output "public_ip" {
  ...
  value       = qiniu_ecs_instance.app.public_ip
}

output "access_url" {
  description = "应用访问地址"
  value       = "http://${qiniu_ecs_instance.app.public_ip}"
}

output "ssh_command" {
  description = "SSH 连接命令"
  value       = "ssh root@${qiniu_ecs_instance.app.public_ip}"
}
```
